...
INPUT_CSV_PATH = SCRIPT_DIR / '../../output/1_handle_missing_data/final_cleaned_dataset.csv'
OUTPUT_CSV_PATH = SCRIPT_DIR / '../../output/2_handle_encoding_data/encoded_payment_method_dataset.csv'
